...
class Gedung_Model extends CI_Model {
    ...
    $sql = "SELECT 
        ...
        -- TAMBAH INI:
        PEMESANAN.JAM_PEMESANAN AS JAM_MULAI,
        PEMESANAN.JAM_SELESAI AS JAM_SELESAI,
    ...
    ORDER BY PEMESANAN_FIX_DETAIL.TANGGAL_FINAL_PEMESANAN ASC, PEMESANAN.JAM_PEMESANAN ASC";
