...
<body class="min-h-screen overflow-y-auto text-white relative overflow-x-hidden
  ...
  bg-cover bg-center bg-no-repeat bg-fixed">
    ...
    <!-- [CHANGED] Dark overlay biar background lebih gelap & kontras -->
    <div class="pointer-events-none absolute inset-0 bg-gradient-to-b from-black/10 via-black/50 to-black/70"></div>

    <!-- Overlay glow + glossy (tetap) -->
    ...
    <main class="relative min-h-screen flex items-start sm:items-center justify-center p-6">
        <div class="w-full max-w-xl py-8">
            ...
            <div class="rounded-2xl border border-white/15 bg-white/10 backdrop-blur-xl shadow-2xl p-8">
                ...
                <!-- [CHANGED] Form closing pakai form_close agar rapih dengan form_open -->
                ...
                <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2" data-field>
                        ...
                        <!-- [CHANGED] Native select dibuat dark + arrow custom -->
                        <div class="relative mt-2">
                            <select id="perusahaan" name="perusahaan" required
                                class="w-full appearance-none rounded-xl bg-white/10 border border-white/15 px-4 py-3 pr-10
                    ...
                    <div data-field>
                      ...
                      text-[#D7FFF8] hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20"
                                ...
                                <!-- [CHANGED] icon default eye-slash -->
