            ...
            <div class="container">
               <div class="row">
                  <div class="col s12 m5 l6">
                        <a class="waves-effect waves-light btn" href="<?php echo site_url('admin/add_gedung') ?>" data-activates="dropdown54" id="sort"><i class="material-icons right">add</i>tambah gedung</a>                        
                    </div>
               </div>
            </div>
            <div class="container">
                  ...
                  <table class="bordered" style="width: 1090px">
                  	...
                  	<?php $no = 0; foreach($res as $row): $no++; ?>
                  	<tr>
                  		...
                  		<td><?php echo number_format($row['HARGA_SEWA']); ?></td>
                  		<td><a href="<?php echo site_url('admin/edit/'.$row['ID_GEDUNG'].''); ?>">Edit</a></td>
                  		<td><a href="<?php echo site_url('admin/admin_controls/delete_gedung/'.$row['ID_GEDUNG'].'') ?>" onclick="return dialog();">Delete</a></td>
                  	</tr>
                  	<?php endforeach; ?>
                  </table>
                  </div>
