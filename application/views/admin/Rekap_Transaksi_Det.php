    ...
    <header>
        ...
        <ul id="nav-mobile" class="side-nav" style="width: 240px;">
            ...
            <li class="bold">
                ...
                <a href="<?php echo site_url('admin/pembayaran') ?>" class="waves-effect waves-teal">Transaksi<span
                        class="new badge"><?php echo $get_transaction ?></span></a>
                <?php endif;?>
                <?php if($get_transaction <= 0): ?>
            <li class="bold">
        ...
        <center>
            <h5>Rekapitulasi Transaksi</h5><br>
            <b>Periode
                <?php echo date_format(date_create($start_date), 'd/m/Y') ?>-<?php echo date_format(date_create($end_date), 'd/m/Y') ?></b>
            <div class="container">
                <div class="row">
