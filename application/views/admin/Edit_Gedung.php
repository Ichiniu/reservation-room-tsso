    ...
    <header class="fixed top-0 left-0 right-0 z-20 bg-white border-b border-gray-200">
        <div class="h-16 px-4 md:px-6 flex items-center gap-3">
            ...
            <div class="ml-auto text-sm text-gray-600">
                <?php echo htmlspecialchars((string)($session_id ?? '-'), ENT_QUOTES, 'UTF-8'); ?>
            </div>
        </div>
    </header>
                ...
                <div class="p-4 md:p-6">
                    <?php foreach ($result as $row): ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <?php
                            $pm_val = (string)($row['PRICING_MODE'] ?? '');
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="hidden" id="harga_halfday_pp" name="harga_halfday_pp"
                                                value="<?php echo htmlspecialchars((string)($row['HARGA_HALF_DAY_PP'] ?? 30000), ENT_QUOTES, 'UTF-8'); ?>">
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="hidden" id="harga_fullday_pp" name="harga_fullday_pp"
                                                value="<?php echo htmlspecialchars((string)($row['HARGA_FULL_DAY_PP'] ?? 60000), ENT_QUOTES, 'UTF-8'); ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="hidden" id="harga_audio_per_jam" name="harga_audio_per_jam"
                                                value="<?php echo htmlspecialchars((string)($row['HARGA_AUDIO_PER_JAM'] ?? 150000), ENT_QUOTES, 'UTF-8'); ?>">
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="hidden" id="harga_video_per_jam" name="harga_video_per_jam"
                                                value="<?php echo htmlspecialchars((string)($row['HARGA_VIDEO_PER_JAM'] ?? 200000), ENT_QUOTES, 'UTF-8'); ?>">
                                        </div>
                                    </div>
                                </div>
