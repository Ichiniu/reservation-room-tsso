                            ...
                            <div>
                                ...
                                <div class="flex gap-3 mt-3 flex-wrap">
                                    ...
                                    <div class="w-40 h-28 rounded overflow-hidden border relative">
                                        <img src="<?= htmlspecialchars($img['PATH'] . $img['IMG_NAME'], ENT_QUOTES, 'UTF-8') ?>"
                                            alt="Foto" class="w-full h-full object-cover">
                                        <button type="button"
                                            data-img="<?= htmlspecialchars($img['IMG_NAME'], ENT_QUOTES, 'UTF-8') ?>"
                                            data-id="<?= (int)$row['ID_GEDUNG'] ?>" title="Hapus"
                                            class="delete-image-btn absolute top-1 right-1 bg-white/90 hover:bg-white text-red-600 rounded-full p-1 shadow z-50"
                                            style="pointer-events:auto;">
                                            <i class="material-icons text-xs">delete</i>
                                        </button>
                                        <div
                                            class="absolute left-1 bottom-1 bg-white/80 px-1 rounded text-xs text-gray-700">
                                            <?= htmlspecialchars($img['IMG_NAME'], ENT_QUOTES, 'UTF-8') ?></div>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                                <?php else: ?>
