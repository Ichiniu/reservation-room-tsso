...
<head>
    ...
    <title>Laporan Perawatan Keselurhan</title>
...
<body>
    <header>
        ...
        <ul id="nav-mobile" class="side-nav fixed" style="width: 240px;">
            ...
            <li class="bold">
                <a href="<?php echo site_url('manage/report_perawatan') ?>" class="waves-effect waves-teal">Laporan
                    Perawatan Ruangan</a>
            </li>
            <li class="bold">
                <a href="<?php echo site_url('manage/report_kegiatan') ?>" class="waves-effect waves-teal">Laporan
                    Kegiatan Ruangan</a>
            </li>
            <li class="bold">
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12">
                    <center>
                        <h5><b>Laporan Pembayaran Keselurahan</b></h5>
                    </center>
                    ...
                    <table style="display: inline-block;">
                        ...
                        <tr>
                            <td>
                                <a href="<?php echo site_url('manage/download_pdf') ?>">Ekspor ke PDF</a>
                            </td>
                        </tr>
                    </table>
                </div>
