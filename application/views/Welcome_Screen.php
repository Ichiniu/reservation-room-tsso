    ...
    <main class="py-8 sm:py-10">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section class="mb-10">
                ...
                <p class="text-sm text-slate-600">Jelajahi ruang meeting yang tersedia di Smart Office Tiga Serangkai.
                </p>
            </section>
                ...
                <article
                    ...
                    <div class="flex-1 flex flex-col p-4 space-y-2">
                        ...
                        <p class="text-sm text-slate-500">
                            Kapasitas hingga <span class="font-semibold text-slate-800"><?= $row['KAPASITAS']; ?>
                                orang</span>
