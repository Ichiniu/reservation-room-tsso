...
<body>
    <div class="container">
        ...
        <!--/ freshdesignweb top bar -->
        <header>
            <h1>Form Pembayaran Ruangan</h1>
        </header>
        <div class="form">
            <?php echo form_open_multipart('pembayaran/frm_pembayaran'); ?>
            <p class="contact"><label for="no_pemesanan">No Pemesanan</label></p>
            <input id="no_pemesanan" name="no_pemesanan" placeholder="Contoh: PMSN0021" required="" tabindex="1"
                type="text">
            <p class="contact"><label for="atas_nama">Rekening Atas Nama</label></p>
            <input id="atas_nama" name="atas_nama" placeholder="Contoh: Warsito Nugroho" required="" type="text">
            <p class="contact"><label for="jumlah_transfer">Nominal Transfer</label></p>
            <input type="text" id="jumlah_transfer" name="jumlah_transfer" placeholder="Contoh: 50000000" required="">
            <p class="contact"><label for="bank_dari">Bank Anda</label></p>
            <input type="text" id="bank_dari" name="bank_dari" placeholder="Contoh: Mandiri, BCA" required="">
            </fieldset>
            <br>
            <br>
